...
archivo = open('iris-presentaciones.txt', 'w+')
...
while i < 20000:
  if ano > 2011 or mes > 11 or (mes == 11 and dia >= 4):
    break
  archivo.write("({:d},'{:02d}-{:02d}-{:d} 20:00:00',TRUE,5,null,null),\n".format(i, dia, mes, ano))
...
ano = 2012
while i < 20000:
  if ano > 2012 or mes > 8 or (mes == 8 and dia >= 15):
    break
  archivo.write("({:d},'{:02d}-{:02d}-{:d} 20:00:00',TRUE,5,null,null),\n".format(i, dia, mes, ano))
  dia, mes, ano = siguiente_dia(dia, mes, ano)
  i += 1
...
ano = 2017
while i < 20000:
  if ano > 2017 or mes > 6 or (mes == 6 and dia >= 12):
    break
  archivo.write("({:d},'{:02d}-{:02d}-{:d} 20:00:00',FALSE,5,null,null),\n".format(i, dia, mes, ano))
  dia, mes, ano = siguiente_dia(dia, mes, ano)
  i += 1
...
ano = 2018
while i < 20000:
  if ano > 2018 or mes > 2 or (mes == 2 and dia >= 12):
    break
  archivo.write("({:d},'{:02d}-{:02d}-{:d} 20:00:00',TRUE,5,null,null),\n".format(i, dia, mes, ano))
  dia, mes, ano = siguiente_dia(dia, mes, ano)
  i += 1
